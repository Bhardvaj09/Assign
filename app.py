...
# For Streamlit Cloud, also check st.secrets
if not api_key:
    try:
...
"""
            ...
            st.info("For Streamlit Cloud: Add OPENAI_API_KEY in Secrets")
            st.info("For Local: Create .env file with OPENAI_API_KEY=your-key")
